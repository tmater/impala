...
struct TPlanNode {
  ...
  12: optional THBaseScanNode hbase_scan_node
  13: optional TKuduScanNode kudu_scan_node
  14: optional TDataSourceScanNode data_source_node
  15: optional TJoinNode join_node
  16: optional TAggregationNode agg_node
  17: optional TSortNode sort_node
  18: optional TUnionNode union_node
  19: optional TExchangeNode exchange_node
  20: optional TAnalyticNode analytic_node
  21: optional TUnnestNode unnest_node
  22: optional TIcebergMetadataScanNode iceberg_scan_metadata_node
  ...
  24: optional string label_detail

  // Estimated execution stats generated by the planner.
  25: optional ExecStats.TExecStats estimated_stats

  // Runtime filters assigned to this plan node
  26: optional list<TRuntimeFilterDesc> runtime_filters

  // Resource profile for this plan node.
  27: required ResourceProfile.TBackendResourceProfile resource_profile

  28: optional TCardinalityCheckNode cardinality_check_node
}
