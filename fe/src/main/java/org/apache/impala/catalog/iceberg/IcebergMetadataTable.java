...
public class IcebergMetadataTable extends VirtualTable {
  ...
  public IcebergMetadataTable(FeTable baseTable, List<String> tblRefPath)
    ...
    MetadataTableType type = MetadataTableType.valueOf(metadataTableTypeString.toUpperCase());
    Table metadataTable = MetadataTableUtils.createMetadataTableInstance(baseTable_.getIcebergApiTable(), type);
  ...
  /**
   * Returns true if the specified virtual table name is a valid Iceberg Metadata table
   * name.
   */
  public static Boolean isIcebergMetadataTable(String vtable_name) {
    return EnumUtils.isValidEnum(MetadataTableType.class, vtable_name.toUpperCase());
  }
}
